...
void SubTemperatures::onConnected()
{
   m_qout << "connected" << endl;
   subscribe("temperature", 0);
}

void SubTemperatures::onSubscribed(const QString& topic, const quint8 qos)
{
   m_qout << "subscribed: " << topic << endl;
}

void SubTemperatures::onReceived(const QMQTT::Message& message)
{
